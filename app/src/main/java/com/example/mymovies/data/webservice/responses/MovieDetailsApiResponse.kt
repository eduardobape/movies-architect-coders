package com.example.mymovies.data.webservice.responses
...
data class MovieDetailsSearchRemoteResult(
    ...
    @Json(name = "backdrop_path") val backdropImageRelativePath: String?,
    ...
    @Json(name = "poster_path") val posterImageRelativePath: String?,
