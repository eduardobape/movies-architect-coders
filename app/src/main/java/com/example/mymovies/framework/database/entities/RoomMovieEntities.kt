package com.example.mymovies.framework.database.entities
...
data class MoviesPaginationInfo(
    ...
    @ColumnInfo(name = "total_movies") val totalMovies: Int
)
...
fun MovieGenre.toMovieGenreDomainModel(): MovieGenreDomainModel =
    MovieGenreDomainModel(id, name)

fun MoviesPaginationInfo.toPaginationInfoDomainModel(): ItemsPaginationInfo =
    ItemsPaginationInfo(
        lastPageLoaded,
        totalPages,
        totalMovies
